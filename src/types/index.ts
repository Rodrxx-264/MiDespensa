...
export type PrecioGemini = { tienda: string; precio: number; presentacion: string };
export type ResultadoGemini = { precios: PrecioGemini[]; recomendacion: string; texto: string };
