...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user && local) return <div className="min-h-screen bg-crema md:grid md:grid-cols-[240px_1fr]"><Sidebar user={{ nombre: "Invitado local", avatar_url: null }} /><main className="pb-24 md:pb-0"><div className="mx-auto max-w-6xl p-4 md:p-8">{children}</div></main><NavbarMobile /></div>;
