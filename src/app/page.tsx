...
export default function Home() {
  return <main className="min-h-screen bg-crema px-5 py-8 md:px-10">
    ...
    <section className="mx-auto grid max-w-6xl gap-10 py-16 md:grid-cols-[1.1fr_.9fr] md:items-center">
      <div><p className="font-semibold uppercase tracking-[.25em] text-bosque">Compras familiares en Guatemala</p><h1 className="mt-4 text-4xl font-black tracking-tight text-tinta md:text-6xl">Tu lista familiar, sincronizada y con precios inteligentes.</h1><p className="mt-5 text-lg text-tinta/75">Crea grupos por QR, compra en tiempo real y consulta precios de Walmart Guatemala, La Torre, Paiz, Super 24 y más con Gemini.</p><div className="mt-8 flex flex-wrap gap-3"><Link href="/auth/login"><Button size="lg">Continuar con Google</Button></Link><Link href="/unirse"><Button variant="secondary" size="lg">Unirme por código</Button></Link></div></div>
